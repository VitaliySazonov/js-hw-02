...
const addLogin = (allLogins, login) =>
  !isLoginValid(login) ? 'Ошибка! Логин должен быть от 4 до 16 символов' :
    !isLoginUnique(allLogins, login) ? 'Такой логин уже используется!' :
      (allLogins.push(login), 'Логин успешно добавлен!')
/*
 * Вызовы функции для проверки работоспособности твоей реализации.
 */
console.log(addLogin(logins, 'Ajax'), logins); // 'Логин успешно добавлен!'
console.log(addLogin(logins, 'JQoflops'), logins); // 'Логин успешно добавлен!'
